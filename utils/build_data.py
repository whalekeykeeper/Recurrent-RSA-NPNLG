    ...
    if proceed == "y":
        ...
        def make_id_to_caption():
            ...
            json_data = json.loads(
                open(
                    "charpragcap/resources/visual_genome_JSON/region_descriptions.json",
                    "r",
                ).read()
            )
            ...
            pickle.dump(
                id_to_caption, open("charpragcap/resources/id_to_caption", "wb")
            )
        ...
        def store_image_reps():
            id_to_caption = pickle.load(
                open("charpragcap/resources/id_to_caption", "rb")
            )
